 ...
 */
public class WriteOprHeader2_6 extends WriteOprHeader {

	final private StorageType storageType;
	final private StorageType[] allStorageTypes;
	final private boolean allowLazyPersist;

	public WriteOprHeader2_6(ExtendedBlock blk, StorageType storageType, Token<BlockTokenIdentifier> blockToken, String clientName,
