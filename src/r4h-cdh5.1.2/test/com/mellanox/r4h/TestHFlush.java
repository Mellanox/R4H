...
public class TestHFlush {
  ...
  public void hFlush_01() throws IOException {
    doTheJob(new HdfsConfiguration(), fName, MiniDFSClusterBridge.getAppendTestUtil_BLOCK_SIZE(),
  ...
  public static void doTheJob(Configuration conf, final String fileName,
    ...
    try {
      ...
      assertEquals("File size doesn't match ", MiniDFSClusterBridge.getAppendTestUtils_FILE_SIZE(), fileSystem.getFileStatus(path).getLen());
