 ...
 * This is the extension for Hadoop 2.5.0
 */
public class WriteOprHeader2_5 extends WriteOprHeader {

	final private StorageType storageType;
	final private StorageType[] allStorageTypes;

	public WriteOprHeader2_5(ExtendedBlock blk, StorageType storageType, Token<BlockTokenIdentifier> blockToken, String clientName,
