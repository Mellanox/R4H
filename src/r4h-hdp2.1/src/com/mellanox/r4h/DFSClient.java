...
public class DFSClient implements java.io.Closeable, RemotePeerFactory {
  ...
  int getDatanodeWriteTimeout(int numNodes) {
    return (dfsClientConf.getConfTime() > 0) ?
      (dfsClientConf.getConfTime() + HdfsServerConstants.WRITE_TIMEOUT_EXTENSION * numNodes) : 0;
  }

  int getDatanodeReadTimeout(int numNodes) {
    return dfsClientConf.getSocketTimeout() > 0 ?
        (HdfsServerConstants.READ_TIMEOUT_EXTENSION * numNodes +
            dfsClientConf.getSocketTimeout()) : 0;
  }
  ...
  public BlockStorageLocation[] getBlockStorageLocations(
    ...
    Map<DatanodeInfo, HdfsBlocksMetadata> metadatas = BlockStorageLocationUtilBridge
  ...
  public MD5MD5CRC32FileChecksum getFileChecksum(String src) throws IOException {
    ...
    return getFileChecksum(src, clientName, namenode, socketFactory,
        dfsClientConf.getSocketTimeout(), getDataEncryptionKey(),
