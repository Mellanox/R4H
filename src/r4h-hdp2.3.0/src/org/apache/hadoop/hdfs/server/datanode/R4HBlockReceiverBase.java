...
import com.mellanox.r4h.WriteOprHeader2_7;
...
public abstract class R4HBlockReceiverBase extends BlockReceiver {
	public R4HBlockReceiverBase(WriteOprHeader oprHeader, DataInputStream inForHeaderOnly, String sessionInfo, DataNodeBridge dnEx)
	        throws IOException {
		super(oprHeader.getBlock(), ((WriteOprHeader2_7) oprHeader).getStorageType(), inForHeaderOnly, sessionInfo, sessionInfo,
		        ...
		        ((WriteOprHeader2_7) oprHeader).getAllowLazyPersist(), ((WriteOprHeader2_7) oprHeader).getAllowPinning());
	}
}
